...
const Journey = () => {
    return (
        <div className="h-fit py-24 lg:px-40 px-10 flex flex-col md:flex-row gap-x-10 gap-y-10">
            ...
            <Image src={HomeMockup} alt="Home Mockup" quality={100} className='border-4 border-gray-700 rounded-3xl w-2/12 object-contain h-fit' />
            <Image src={MoodManagementMockup} alt="Home Mockup" quality={100} className='border-4 border-gray-700 rounded-3xl w-2/12 object-contain h-fit' />
        </div>
    );
}
